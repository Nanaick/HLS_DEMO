...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "demo_test.autotvin.dat"
	set constFileTvOut       "demo_test.autotvout.dat"
	set constFileHdlTvIn     "demo_test.autohdltvin.dat"
	set constFileHdlTvOut    "demo_test.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
