...
if {[file isfile demo_test.autotvin.dat]} {
	file delete -force demo_test.autotvin.dat
}

if {[file isfile demo_test.autotvout.dat]} {
	file delete -force demo_test.autotvout.dat
}
